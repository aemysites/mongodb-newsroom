...
## Environments
- Preview: https://main--mongodb-newsroom--aemysites.aem.page/
- Live: https://main--mongodb-newsroom--aemysites.aem.live/
- Block Library: https://main--mongodb-newsroom--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `mongodb-newsroom` directory in your favorite IDE and start coding :)
